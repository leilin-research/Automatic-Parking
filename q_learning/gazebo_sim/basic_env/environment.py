...
class Environment(object):
    ...
    def hit_wall_check(self, pose):
        if pose[0] > self.cars_boundary[1][1] and pose[0] < self.cars_boundary[0][1] \
            and pose[1] > self.cars_boundary[0][2] - 0.2 and pose[1] < self.agent_move_boundary[0][3] + self.car_width:
            return False
        else:
            print "**********************************************************************************************"
    ...
    def set_agent_appro_move_boundary(self):
        ...
        self.agent_move_boundary[0][0] = 0.76
        self.agent_move_boundary[0][1] = 0.84
        self.agent_move_boundary[0][2] = -1.44
        self.agent_move_boundary[0][3] = -1.36
