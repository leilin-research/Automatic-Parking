#!/usr/bin/env python
# -----------------------------------
# save images received from cameras mounted on the ackermann car
# Author: Tao Chen
# Date: 2016.10.16
# -----------------------------------
import rospy
...
class saver:
    def __init__(self):
        ...
        self.cameraFront_sub = rospy.Subscriber("/ackermann_vehicle/multi/camera/basler/left/image_raw", Image,
                                              self.cameraFront_callback)
        self.cameraRight_sub = rospy.Subscriber("/ackermann_vehicle/multi/camera/basler2/right/image_raw", Image,
                                              self.cameraRight_callback)
        self.cameraBack_sub = rospy.Subscriber("/ackermann_vehicle/multi/camera/basler3/right/image_raw", Image,
                                                self.cameraBack_callback)
        self.cameraLeft_sub = rospy.Subscriber("/ackermann_vehicle/multi/camera/basler4/left/image_raw", Image,
                                               self.cameraLeft_callback)
