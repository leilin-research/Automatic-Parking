...
class saver:
    def __init__(self):
        ...
        self.img_dir = os.path.join(self.current_path, 'images_near_terminal')
    ...
    def set_car_move_boundary(self):
        # near_wall_tolerance = 1.2 * self.car_length
        # near_fixed_car_tolerance = 1.2 * self.car_length
        ...
        #
        # self.car_move_boundary[0][0] = max(self.car_move_boundary[0][0], self.cars_boundary[1][0] - self.car_length * 2.0)
        # self.car_move_boundary[0][1] = min(self.car_move_boundary[0][1], self.cars_boundary[0][1] + self.car_length * 2.0)
        # self.car_move_boundary[0][2] = max(self.car_move_boundary[0][2], self.cars_boundary[0][2] - self.car_length * 2.0)
        # self.car_move_boundary[0][3] = min(self.car_move_boundary[0][3], self.cars_boundary[0][3] + self.car_length * 2.0)
        #
        ...
        # # Down, 0 or pi
        # x_offset = 1.0 * self.car_length
        # y_offset = 0.6 * self.car_width
        #
        # self.car_move_boundary = np.zeros(4)  # xmin, xmax, ymin, ymax
        # self.car_move_boundary[0] = self.cars_boundary[1][0] - x_offset
        # self.car_move_boundary[1] = self.cars_boundary[0][1] + x_offset
        # self.car_move_boundary[2] = self.cars_boundary[0][3] + y_offset
        # self.car_move_boundary[3] = self.cars_boundary[0][3] + 1.5 * y_offset
        ...
        # self.car_move_boundary[0] = self.cars_boundary[1][0] - x_offset
        # self.car_move_boundary[1] = self.cars_boundary[0][1] + x_offset
        # self.car_move_boundary[2] = self.cars_boundary[0][2] - y_offset
        # self.car_move_boundary[3] = self.cars_boundary[0][2] - 1.5 * y_offset
        #
        # # Left
        # x_offset = 0.6 * self.car_length
        # y_offset = 1.0 * self.car_width
        #
        # self.car_move_boundary = np.zeros(4)  # xmin, xmax, ymin, ymax
        # self.car_move_boundary[0] = self.cars_boundary[0][1] + x_offset
        # self.car_move_boundary[1] = self.cars_boundary[0][1] + 3.0 * x_offset
        # self.car_move_boundary[2] = self.cars_boundary[0][2] - y_offset
        # self.car_move_boundary[3] = self.cars_boundary[0][3] + y_offset
        #
        # # Right
        # x_offset = 0.6 * self.car_length
        # y_offset = 1.0 * self.car_width
        ...
        # self.car_move_boundary = np.zeros(4)  # xmin, xmax, ymin, ymax
        # self.car_move_boundary[0] = self.cars_boundary[1][0] - x_offset
        # self.car_move_boundary[1] = self.cars_boundary[1][0] - 1.5 * x_offset
        # self.car_move_boundary[2] = self.cars_boundary[0][2] - y_offset
        # self.car_move_boundary[3] = self.cars_boundary[0][3] + y_offset

        # # Down, any angle
        # x_offset = 1.0 * self.car_length
        # y_offset = 0.6 * self.car_length
        #
        # self.car_move_boundary = np.zeros(4)  # xmin, xmax, ymin, ymax
        # self.car_move_boundary[0] = self.cars_boundary[1][0] - x_offset
        # self.car_move_boundary[1] = self.cars_boundary[0][1] + x_offset
    ...
    def generate_car_pose(self):
        ...
        #         break
        x = random.uniform(self.car_move_boundary[0], self.car_move_boundary[1])
        y = random.uniform(self.car_move_boundary[2], self.car_move_boundary[3])
        z = 0.105
        # i = random.uniform(0, 1)
        # angle_tol = 0.174   # 10 degree
        # # angle_tol = 0.0873
        # if i > 0.5:
        #     theta = random.uniform(-angle_tol, angle_tol)
        # else:
        #     theta = random.uniform(np.pi - angle_tol, np.pi + angle_tol)
        theta = random.uniform(0, 2 * np.pi)
