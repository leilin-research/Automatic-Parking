...
class saver:
    def __init__(self):
        ...
        self.img_dir = os.path.join(self.current_path, 'images_at_terminal_wrong_angle')
    ...
    def set_car_move_boundary(self):
        ...
        x_offset = 0.57 * self.car_length
        y_offset = -1.0 * self.car_width

        self.car_move_boundary = np.zeros(4)  # xmin, xmax, ymin, ymax (Outer Suqare, Innder boundary square)
        self.car_move_boundary[0] = self.cars_boundary[1][1] + x_offset
        self.car_move_boundary[1] = self.cars_boundary[0][0] - x_offset
