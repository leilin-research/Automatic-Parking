...
class Environment(object):
    ...
    def act(self, agent, action):
        ...
        self.env_sleep(self.step_length / self.speed)
    ...
    def set_agent_appro_move_boundary(self):
        ...
        self.agent_move_boundary[0][0] = -0.84
        self.agent_move_boundary[0][1] = -0.76
        self.agent_move_boundary[0][2] = -2.64
        self.agent_move_boundary[0][3] = -2.56
